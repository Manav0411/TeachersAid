...
import { ANSWERS_PROMPT } from "@/lib/prompts/answers";
import { ExtractAnswersModelResponse, ExtractAnswersRequest } from "@/lib/schemas";
...
export async function POST(req: Request) {
  ...
  const parsedReq = ExtractAnswersRequest.safeParse(body);
  ...
  try {
    ...
    const data = ExtractAnswersModelResponse.parse(raw);
